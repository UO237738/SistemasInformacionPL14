...
public class ModeloCrearActividadHorarioDisplayDTO {
	...
	private ArrayList<ModeloHorarioDisplayDTO> horarios;
	...
	public ArrayList<ModeloHorarioDisplayDTO> getHorarios() {
		return horarios;
	}
	public void setHorarios(ArrayList<ModeloHorarioDisplayDTO> horarios) {
		this.horarios = horarios;
	}
	public ModeloCrearActividadHorarioDisplayDTO() {}
	
	
	public ModeloCrearActividadHorarioDisplayDTO(int idActividad, int idInst, String nombre, int aforo,
			int cuotaS, int cuotaNS, String fechaInicioActividad, String fechaFinActividad,
			int idInsc) {
		this.id_actividad=idActividad;
		this.horarios= new ArrayList<ModeloHorarioDisplayDTO>();
