...
private static Database db=new Database();
	...
	public static void  setNuevoPeriodoInscripcion(ModeloCrearPeriodoInscripcionDisplayDTO PeriodoInscripcion ) {
		Connection dbConnection=null;
		PreparedStatement preparedStatement1= null;

		String insertActividad = "INSERT INTO inscripciones" 
				+"(id_inscripcion, fechaInicioSocios, fechaFinSocios, fechaFinNoSocios) VALUES "
				+"(?,?,?,?)";
		...
		try {
			...
			preparedStatement1.setInt(1, PeriodoInscripcion.getId_periodoInscrip());
